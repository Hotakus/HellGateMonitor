...
void HgmGUI::HgmSetupView::begin()
{
    ...
    //setup_subs.name("setup");
    //setup_subs.subscribe_msg("setup", ctl);
    //HgmFramework::getInstance()->hgmFwCenter.subscribe(&setup_subs);
...
{
    //this->componentInitDone();
    //HgmFramework::getInstance()->hgmFwCenter.unsubscribe(&setup_subs);
